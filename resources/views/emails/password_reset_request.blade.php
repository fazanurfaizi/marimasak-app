              ...
              <table class="email-body_inner" align="center" width="570" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  <td class="content-cell">
                    <h1>Hi {{ $name }},</h1>
                    <p>You recently requested to reset your password for your {{ config('app.name', 'Marimasak') }} account. Click the button below to reset it.</p>
                    <!-- Action -->
          ...
          <tr>
            <td>
              <table class="email-footer" align="center" width="570" cellpadding="0" cellspacing="0">
                <tr>
                  <td class="content-cell">
                    <p class="sub center">&copy; 2021 {{ config('app.name', 'Marimasak') }}. All rights reserved.</p>
                    <p class="sub center">
